  ...
  <div class="app-container">
      ...
      <el-row>
        <el-col :span="24">
          <el-table
            ...
            <el-table-column align="left" prop="itemType" label="办件类型" width="200">
            </el-table-column>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogForm" width="400px" id="formdialog"
      ...
      <el-form :model="form" class="demo-ruleForm forms" id="formdata" ref="ruleForm" :rules="rules">
        <el-row>
          <el-col>
            <el-form-item label="事项主题" :label-width="formLabelWidth" prop="itemType">
              <el-input v-model="form.itemType" class="inputWidth"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
