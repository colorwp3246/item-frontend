  ...
  <div class="app-container">
      ...
      <el-row>
        <el-col :span="24">
          <el-table
            ...
            <el-table-column align="left" prop="operationLogo" label="系统图标" width="120">
              <template slot-scope="scope">
                <img :src="scope.row.operationLogo"  min-width="70" height="70" />
              </template>
            </el-table-column>
            <el-table-column align="left" prop="operationName" label="系统名称" width="200">
            </el-table-column>
            <el-table-column align="left" prop="operationUrl" label="访问地址">
            </el-table-column>
            <el-table-column align="left" prop="operationPrincipal" label="联系人" width="200">
            </el-table-column>
            <el-table-column align="left" prop="operationPrincipalTel" label="联系方式" width="200">
            </el-table-column>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogForm" width="600px" id="formdialog"
      ...
      <el-form :model="form" class="demo-ruleForm forms" id="formdata" ref="ruleForm" :rules="rules">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="系统负责人" :label-width="formLabelWidth">
              <el-input v-model="form.operationPrincipal" class="inputWidth"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="联系电话" :label-width="formLabelWidth">
              <el-input v-model="form.operationPrincipalTel" class="inputWidth"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col>
            <el-form-item label="系统地址" :label-width="formLabelWidth" prop="operationUrl">
              <el-input v-model="form.operationUrl" class="inputWidth"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col>
            <el-form-item label="系统图片" :label-width="formLabelWidth">
              <el-input v-model="form.operationLogo" class="inputWidth"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col>
            <el-form-item label="系统描述" :label-width="formLabelWidth">
              <el-input type="textarea" v-model="form.operationIntroduce" class="inputWidth"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
  ...
  export default {
    data() {
      const validateName = (rule, value, callback) => {
        ...
        if (!value) {
          callback(new Error('请输入系统地址'));
        } else {
          callback();
        }
      }
      return {
        model:'operation',//接口模块名称
        totalPage:'',
        pageIndex:1,
        list: [],
        selectedCheckbox:[],
