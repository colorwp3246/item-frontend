  ...
  <div class="app-container">
      ...
      <el-row>
        <el-col :span="24">
          <el-table
            ...
            <!--</el-table-column>-->
            <el-table-column align="left" prop="scene" label="服务场景">
            </el-table-column>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogForm" width="400px" id="formdialog"
      ...
      <el-form :model="form" class="demo-ruleForm forms" id="formdata" ref="ruleForm" :rules="rules">
        <el-row>
          <el-col>
            <el-form-item label="服务场景" :label-width="formLabelWidth" prop="scene">
              <el-input v-model="form.scene" class="inputWidth"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
