...
export default {
  ...
  data () {
    return {
      sliders:[
        {
          img:'https://jwc.xidian.edu.cn/__local/2/C2/1F/5F75D58D23C9F324F1EEC1B4FC0_BD5FF8E7_AFB54.png'
        },
        {
          img:'https://jwc.xidian.edu.cn/images/16/02/28/3yjssxsfje/wq7c_image001.jpg'
        },
        {
          img:'https://jwc.xidian.edu.cn/_mediafile/jwc/2015/07/06/2vtvr2s3w4.jpg'
        },
        {
          img:'https://jwc.xidian.edu.cn/__local/2/C2/1F/5F75D58D23C9F324F1EEC1B4FC0_BD5FF8E7_AFB54.png'
        },
  ...
  methods:{
    ...
    move(offset, direction, speed) {
      ...
      direction === -1 ? this.currentIndex += offset/377 : this.currentIndex -= offset/377
    ...
    animate(des, direc, speed) {
      ...
      this.temp = window.setInterval(() => {
        if ((direc === -1 && des < this.distance) || (direc === 1 && des > this.distance)) {
          ...
          window.clearInterval(this.temp)
          this.distance = des
          if (des < -3000) this.distance = -377
          if (des > -377) this.distance = -3000
        }
      }, 20)
    },
    jump(index) {
      const direction = index - this.currentIndex >= 0 ? -1 : 1;
      const offset = Math.abs(index - this.currentIndex) * 377;
