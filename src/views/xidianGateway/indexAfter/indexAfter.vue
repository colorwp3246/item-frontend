...
<script>
  import xdHeard from '../index/heard/LoginHeard'
  import xdFooter from '../public/Footer'
  import xdHotTab from '../index/tab/HotTab'
  import xdUserTab from '../index/tab/UserTab'
  import xdData from '../index/data/Data'
  import xdHotMsg from '../index/data/HotMsg'
  import xdMainData from '../index/data/MainData'
  import xdConvenient from '../index/convenient/Convenient'
  import xdNews from '../index/news/xdNews'
  ...
  export default {
    ...
    data(){
      return{
        ...
        arrSingle:[// 0全部角色进入，1老师权限，2学生权限
          [
            {icon:`${process.env.PICTURE_SERVE}/file?fileId=2ee86c70c4444a56a64eac83252d9894`,title:'学生离校大厅',href:'/LeaveSchool',sceneTypeAfter:1,explain:'此处为本版块场景介绍，此处为本版块场景介绍此处为...'},
            {icon:`${process.env.PICTURE_SERVE}/file?fileId=8fe471b802e3440290b4ae0c399f8c2a`,title:'新员工入职大厅',href:'/Entry',sceneTypeAfter:2,explain:'此处为本版块场景介绍，此处为本版块场景介绍此处为...'},
            {icon:`${process.env.PICTURE_SERVE}/file?fileId=2ee86c70c4444a56a64eac83252d9894`,title:'信息服务大厅',href:'/FullService',sceneTypeAfter:3,explain:'此处为本版块场景介绍，此处为本版块场景介绍此处为...'},
            {icon:`${process.env.PICTURE_SERVE}/file?fileId=2ee86c70c4444a56a64eac83252d9894`,title:'年终考核大厅',href:'',sceneTypeAfter:4,explain:'此处为本版块场景介绍，此处为本版块场景介绍此处为！！！'},
          ],
          [
    ...
    mounted(){
      ...
      this.newPolitical()
      console.log(`${process.env.PICTURE_SERVE}/file?fileId=bb8971299cac4730a37a3081e3d90bb6`)
    },
    methods:{
      newPolitical(){
