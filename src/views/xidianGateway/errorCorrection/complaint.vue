    ...
    <div class="errFrom main clearfloat">
      <div class="fl leftFrom">
        <div class="errFromTitle clearfloat">
          <div class="fl correction">我要投诉</div>
          <div class="fr searErr">查看我的投诉历史</div>
        </div>
        <div class="formVail">
          <div class="clearfloat floatFrom">
            <div class="formTitle fl">涉及事项<i class="iconfont icon-xinghao"  style="color:#ee4444;"></i></div>
            <div class="fl">
              <el-select v-model="errType" placeholder="请选择事项">
                <el-option
          ...
          <div class="clearfloat floatFrom">
            <div class="formTitle fl">投诉主题<i class="iconfont icon-xinghao"  style="color:#ee4444;"></i></div>
            <div class="fl">
              <el-input v-model="pageAddress" placeholder="请输入投诉主题"  v-verify="pageAddress"></el-input>
              <p v-remind="pageAddress" class="tip" style="color:red;margin: 0;"></p>
            </div>
          </div>
          <div class="clearfloat floatFrom">
            <div class="formTitle fl">内容描述<i class="iconfont icon-xinghao"  style="color:#ee4444;"></i></div>
            <div class="fl limit"><textarea  rows="7" placeholder="请描述投诉内容" v-model="errDescribe"></textarea><div class="limitFont">0/6000</div></div>
          </div>
          <div class="clearfloat floatFrom">
  ...
  export default {
    data(){
      return{
        ...
        arr:[
          "您可是在对办事项进行投诉",
          "事项办理信息同步有延迟，如果您在详细选择里面没有找到您的办理事项，请您稍后再试",
          '对您秉持公平公正的态度反馈您所遭遇的问题，我们将公平公正的评估，处理问题'
        ],
        pageAddress:'',
        errType:'',
        errDescribe:'',
