    ...
    <div class="errFrom main clearfloat">
      <div class="fl leftFrom">
        <div class="errFromTitle clearfloat">
          <div class="fl correction">我要建议</div>
          <div class="fr searErr">查看我的建议历史</div>
        </div>
        <div class="formVail">
          <div class="clearfloat floatFrom">
            <div class="formTitle fl">建议标题<i class="iconfont icon-xinghao"  style="color:#ee4444;"></i></div>
            <div class="fl">
              <el-input v-model="pageAddress" placeholder="请输入建议主题"  v-verify="pageAddress"></el-input>
              <p v-remind="pageAddress" class="tip" style="color:red;margin: 0;"></p>
            </div>
          </div>
          <div class="clearfloat floatFrom">
            <div class="formTitle fl">建议描述<i class="iconfont icon-xinghao"  style="color:#ee4444;"></i></div>
            <div class="fl limit"><textarea  rows="7" placeholder="请描述建议内容" v-model="errDescribe"></textarea><div class="limitFont">0/6000</div></div>
          </div>
          <div class="clearfloat floatFrom">
  ...
  export default {
    data(){
      return{
        ...
        values:'',
        arr:[
          "你可以对网站功能，页面，操作以及办理事项不完善的地方进行建议",
        ],
        pageAddress:'',
        errType:'',
        errDescribe:'',
